...
module.exports = async function (options) {
	process.env.NODE_PATH = "D:/Project/Blog/WebContent/node_modules";
	require("module").Module._initPaths();

	const clientConfig = require(options.clientConfig)(options.configFile);
	const serverConfig = require(options.serverConfig)(options.configFile);
